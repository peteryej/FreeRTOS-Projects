...
#define FXOS8700CQ_INT_SOURCE       0x0C   //interrupt
...
#define FXOS8700CQ_M_THS_CFG        0x52  //Magnetometer transient interrupt config
...
#define FXOS8700CQ_M_INT_SRC        0x5E  //magnetometer interrupt 
...
class FXOS8700CQ {
        ...
        uint8_t intSource;        // interrupt source reg
       ...
       void readIntSource(void); //read interrupt source

       void enableInt(uint16_t xThs, uint16_t yThs,uint16_t zThs);  //enable interrupt
       void disableInt(void);  //disable interrupt
};
